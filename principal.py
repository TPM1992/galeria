...
#Creamos Base de datos con nombre "fondos_flask" y la colección "fondos" para usar lo mismo que en la resolución
client = MongoClient("mongodb://localhost:27017")
basedatos = client.fondos_flask
mistareas = basedatos.fondos

#Establecemos la variable titulo y cabecera de las plantillas.
titulo = "Galería de fotos con Flask"
cabecera = "Fondos de pantalla"

#Configuramos el servidor SMTP y creamos la instancia mail (pag 229)
